...
function toggleTheme(theme) {
    ...
    if (theme === 'light') {
        ...
        // 【修改这里】设置图片，并将透明度拉满
        document.body.style.setProperty('--bg-image', 'url("https://pub-2892a14f8bbf4cd488041657b793ac15.r2.dev/000.jpg")');
        ...
        // 【修改这里】直接把图片透明度降为 0 即可，它会像关灯一样渐渐变黑
