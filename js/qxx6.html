...
/* ==========================================================================
   壁纸变量配置使用说明：
   1. 下层背景底色：+color:#005c28 （建议图片链接优先使用 https://）
   2. 上层半透明遮罩：+mask:rgba(127,225,221,0.2)
   3. 平铺与尺寸：#repeat 或 #repeat:32px
   4. 滤镜调节：+sat:0.6 / +contrast:0.8 / +bright:1.2
   ========================================================================== */
...
function crossfadeBackground(bgVal, isLight) {
    ...
    // 1. 提取底色 (+color:#005c28 或 rgb/rgba)
    let underColor = null;
