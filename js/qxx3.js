...
// ================= 背景壁纸变量（支持平铺 repeat 和单张大图） =================
const BG_TOP_LEFT = "url('images/A1.webp') repeat";
const BG_TOP_RIGHT = "url('https://artwork.neocities.org/bgs/stardown.gif') repeat"; // 可替换为你自己的深色 GIF 路径
...
const BG_BOTTOM_RIGHT_2 = 'images/D2.jpg'; // 单张大图，自动居中铺满
...
function crossfadeBackground(bgVal,isLight){
    ...
    const start=(el=null)=>{
        ...
        else if(bgVal.includes('repeat')){
            layer.style.background=bgVal.startsWith('url(')?bgVal:`url('${cleanUrl}') repeat`;
